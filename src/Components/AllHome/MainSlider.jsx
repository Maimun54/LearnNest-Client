...
const MainSlider = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full">
    ...
    <div className='text-white items-center text-center justify-center space-y-7 pl-12 '>
            <h2 className='lg:text-6xl text-4xl py-5 lg:ml-36 text-center font-bold '>Elevate Your Finances: Expert Asset Management Solutions</h2>
  ...
  <div id="slide2" className="carousel-item relative w-full">
    ...
    <h2 className='lg:text-6xl text-4xl py-5 lg:ml-36 text-center font-bold '>Precision Wealth Management for a Prosperous Tomorrow</h2>
